module github.com/governance-platform/proxy
...
require (
	...
	github.com/governance-platform/pkg/calcitepb v0.0.0
...
replace (
	...
	github.com/governance-platform/pkg/calcitepb => ../../pkg/calcitepb
